...
function onEachFeature(feature, layer) {
  ...
  var html = "<h3>" + name + "</h3><strong>Famous for:</strong> " + fame + '"<br><img src="' + image + '" width="100" height="100"> <strong>Address:</strong> "' + address + '<br><br><a href="' + url + '" target="_blank">Get Google Maps directions</a><br><br>';
