...
function onEachFeature(feature, layer) {
  ...
  var html = "<h3>" + name + "</h3><strong>Famous for:</strong> " + fame + "<p><strong>Address:</strong> " + address + '<br><img src="' + image + '" width="150" height="150"> </p><br><a href="' + url + '" target="_blank">Get Google Maps directions</a><br><br>';
